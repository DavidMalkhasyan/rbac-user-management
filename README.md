A full-stack web application with Role-Based Access Control (RBAC). The app allows users to view, edit, or delete other users based on their assigned roles.
